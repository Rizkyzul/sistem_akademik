  ...
  <div class="container-fluid">
    ...
    <div class="col-md-8 col-lg-6">
      ...
      <div class="card-header bg-white p-3">
        ...
        <i class="fas fa-key me-2"></i>Ubah Password Akun Anda
        </h4>
      </div>
      ...
      @endif
        ...
        <div class="mb-3">
          ...
          placeholder="(kebutuhan demoo tidak bia di ubah)" disabled>
        </div>
        <div class="mb-3">
          <label for="new_password_confirmation" class="form-label">Konfirmasi Password Baru</label>
          <input type="password" class="form-control" id="new_password_confirmation"
          name="new_password_confirmation" required placeholder="(kebutuhan demoo tidak bia di ubah)" disabled>
        </div>
